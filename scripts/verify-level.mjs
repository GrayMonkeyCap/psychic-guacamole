...
await page.screenshot({ path: 'artifacts/first-level-empty.png', fullPage: true });
...
await page.screenshot({ path: 'artifacts/first-level-trace.png', fullPage: true });
...
await page.screenshot({ path: 'artifacts/first-level-passed.png', fullPage: true });
...
await page.getByRole('button', { name: 'Send traffic', exact: true }).click();
await page.getByText('CHALLENGE PASSED', { exact: true }).waitFor({ timeout: 22000 });
await page.screenshot({ path: 'artifacts/first-level-final.png', fullPage: true });
...
await page.screenshot({ path: 'artifacts/first-level-certified.png', fullPage: true });
await page.setViewportSize({ width: 1024, height: 768 });
await page.screenshot({ path: 'artifacts/first-level-tablet.png', fullPage: true });
await page.setViewportSize({ width: 390, height: 844 });
await page.screenshot({ path: 'artifacts/first-level-mobile.png', fullPage: true });
